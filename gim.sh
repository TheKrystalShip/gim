...
Manage multiple Godot editor versions.
"
	printf 'Usage: %s [-h|--help] [-v|--version] [-l|--list] [-r|--run <arg>] [-i|--install <arg>] [-d|--delete <arg>] [-m|--(no-)mono] [-e|--(no-)experimental] [-o|--(no-)online]\n' "$0"
	printf '\t%s\n' "-h, --help: Prints help"
	printf '\t%s\n' "-v, --version: Prints version"
	printf '\t%s\n' "-l, --list: Lists all installed Godot editor versions."
	printf '\t%s\n' "-r, --run: Run a specific installed Godot Editor version. If called without a version, run the latest installed. Fails if the specific version is not present or no versions are installed (no default)"
	...
	printf '\t%s\n' "-m, --mono, --no-mono: List/install mono build instead of standard build. (off by default)"
	printf '\t%s\n' "-e, --experimental, --no-experimental: List available experimental versions (only works with --online) (off by default)"

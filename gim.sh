...
{
	local first_option all_short_options='hvlridmo'
	first_option="${1:0:1}"
...
Manage multiple Godot editor versions.
"
	printf 'Usage: %s [-h|--help] [-v|--version] [-l|--list] [-r|--run <arg>] [-i|--install <arg>] [-d|--delete <arg>] [-m|--(no-)mono] [-o|--online]\n' "$0"
	printf '\t%s\n' "-h, --help: Prints help"
	...
	printf '\t%s\n' "-m, --mono, --no-mono: Download mono build instead of standard build (off by default)"
	printf '\t%s\n' "-o, --online: List latest online versions"
}
